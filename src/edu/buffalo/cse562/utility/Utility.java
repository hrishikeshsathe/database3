...
//		System.gc();
	...
	public static Expression handleOrExpression(Expression orExpression) {
		while(!(((BinaryExpression) orExpression).getLeftExpression() instanceof Column)){
			orExpression = ((BinaryExpression) orExpression).getLeftExpression();
		}
		return ((BinaryExpression)orExpression).getLeftExpression();
	}
